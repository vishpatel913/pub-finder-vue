...
describe('distanceBetweenCoords', () => {
  it('should return a vaguely correct distance between two coords', () => {
...
describe('bearingBetweenCoords', () => {
  it('should return a vaguely correct bearing between two coords', () => {
...
describe('timeToWalkDistance', () => {
  it('should return a vaguely correct walking time for a distance', () => {
